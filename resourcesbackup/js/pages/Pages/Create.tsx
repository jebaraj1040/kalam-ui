...
import { ChevronDown, ChevronUp, Eye, GripVertical, Plus, Trash2 } from 'lucide-react';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex items-center justify-between px-6 py-5">
                <p className="font-tree-regular text-base text-font-primary">
                    Pages <span className="font-tree-semibold">/ Create Page</span>
                </p>
                <div className="flex gap-4">
                    <Button variant={'secondary'} title="Cancel" type="button" className="w-[120px]" onClick={() => window.alert('Cancelled')}>
                        Cancel{' '}
                    </Button>
            ...
            <div className="grid h-full grid-cols-4 gap-6.5">
                <div className="pageLeft rounded-r-xl border border-l-0 border-border bg-grey p-4">
                    ...
                    <div className="mb-6">
                        <label className="font-tree-medium mb-3 block text-sm text-font-secondary">
                            Page Name <sup className="text-red">*</sup>
                        </label>
                        <input
                            type="text"
                            value={pageName}
                            onChange={(e) => setPageAndSlugVal(e.target.value)}
                    ...
                    <div className="mb-6">
                        <label className="font-tree-medium mb-3 block text-sm text-font-secondary">
                            Slug<sup className="text-red">*</sup>
                        </label>
                        <input
                            type="text"
                            value={pageSlug}
                            onChange={(e) => setSlugAndAddBlur(e.target.value)}
                            className="form-input w-full"
                            placeholder="Enter component name"
                        />
                        {slugAvailable !== null && (
                    ...
                    {selectedTemplateId && (
                        ...
                        <div className="mb-6">
                            <label className="font-tree-medium mb-3 block text-sm text-font-secondary">
                                Status {activeLang.toUpperCase()} <sup className="text-red">*</sup>
                            </label>
                            <ToggleGroup type="single" variant={'outline'} value={statusPerLang[activeLang]}
                                onChange={(e) =>
                                ...
                                <ToggleGroupItem value={'Publish'}>Publish</ToggleGroupItem>
                    ...
                    <div className="my-6">
                        ...
                        <Dialog>
                            <DialogTrigger asChild>
                                <div className="cursor-pointer rounded-xl border border-dashed border-border bg-input p-5">
                                    <div className="mx-auto flex max-w-[165px] flex-col items-center gap-y-1 hover:cursor-pointer">
                                        ...
                                        <p className="font-tree-medium text-sm leading-5">Import templates</p>
                            ...
                            <DialogPortal>
                                ...
                                >
                                    <DialogTitle className="font-tree-medium mb-[2px] text-sm leading-[140%] text-[#111111] sm:text-base md:text-xl">
                                    ...
                                    <div className="item-center mb-4 flex w-full flex-col justify-between gap-4 sm:mb-8 md:flex-row md:gap-6">
                                        ...
                                        <div className="flex justify-between gap-x-5 md:justify-start">
                                            <Select>
                                                <SelectTrigger className="font-tree-medium min-w-[140px] justify-between text-sm text-font-primary">
                                            ...
                                            <Select>
                                                <SelectTrigger className="font-tree-medium text-sm text-font-primary">
                                                        ...
                                                        <CardContent className="p-0">
                                                            ...
                                                            <div className="mb-2 flex items-center space-x-2">
                                                                <Checkbox
                                                                    ...
                                                                    tabIndex={3}
                                                                />
                                                                <Label htmlFor={comp.id} className="font-tree-medium text-sm text-[#111]">
                                                                    {comp.component_name}
                                                                </Label>
                                                                <Badge
                                                                    variant="default"
                                                            ...
                                                            <div className="ml-[22px] flex items-center gap-x-2">
                                                                {comp.schema.map((s) => (
                                                                    <Badge
                                                                        key={s.id}
                                                                        variant="default"
                                                                        className="font-regular rounded-4xl border border-[#e1e1e1] bg-white px-2 py-1 text-xs text-[#111] capitalize"
                                                                    >
                                                                        {s.title}
                                                                    </Badge>
                                                                ))}
                                    ...
                                    <div className="flex w-full justify-end gap-4 md:gap-6">
                                        ...
                                        <Button variant={'default'} title="Save" type="button" className="w-1/2 md:w-[120px]">
                                            Import{' '}
                                        </Button>
                                    </div>
                ...
                <div className="pageRight col-span-3 rounded-l-xl border border-r-0 border-border bg-grey px-6 py-4">
                    <div className="flex items-center justify-between">
                        <p className="font-tree-semibold mb-0 text-lg text-font-secondary">2. Templates</p>
                        <p className="cursor-pointer !text-[12px] font-semibold text-primary">View Hidden Components (2)</p>
                    </div>
                    {/* <div className="grid grid-cols-1"> */}
                    <div className="relative mt-6 mb-6">
                        <div className="!w-full max-w-[320px]">
                            <label className="font-tree-medium mb-3 block text-sm text-font-secondary">Search and Add Template</label>
                            <input
                                type="text"
                            ...
                            {templateSearchTerm.trim() && (
                                <div className="absolute mt-1 max-h-48 w-full max-w-[320px] overflow-y-auto rounded-xl border bg-input">
                                    {templates
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {languages.map((lang) => (
                                        <button
                                            ...
                                            className={`rounded-[40px] border border-gray-300 bg-input px-3 py-[6px] !text-[12px] ${activeLang === lang.code ? 'border-primary !bg-accent text-primary' : 'bg-white text-black'}`}
                                        >
                        ...
                        <div className="mt-6 rounded-xl bg-background p-6 first:mt-0">
                            {availableComponentsPerLang[activeLang]?.length > 0 && (
                                <>
                                    <div className="flex items-center gap-6">
                                        {availableComponentsPerLang[activeLang].map((comp) => (
                                            <div key={comp.local_id} className="childCard">
                                                <button
                                                    onClick={() => handleAddComponent(activeLang, comp)}
                            ...
                            {componentFormsPerLang[activeLang]?.map((inst) => (
                                <Disclosure key={inst.uid} defaultOpen>
                                    {({ open }) => (
                                        <div className="childCard mt-5 rounded-xl border-l-2 border-primary bg-grey p-4 first:mt-0 last:mb-0">
                                            
                                            <div {...attributes} {...listeners}>
                                                <Disclosure.Button className="flex w-full justify-between text-left text-sm font-medium">
                                                    <div className="flex items-center gap-2">
                                                        <GripVertical />
                                                        <span className="font-tree-medium mb-0 text-[16px]">
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        <button
                                                            ...
                                                            className="font-tree-semibold cursor-pointer text-primary"
                                                            type="button"
                                                            title="Delete"
                                                        >
                                                        ...
                                                        <button
                                                            onClick={() => handleRemoveComponent(activeLang, inst.uid)}
                                                            className="font-tree-semibold cursor-pointer text-[#4F4F4F]"
                                                            type="button"
                                                            title="Eye"
                                                        >
                                                ...
                                                <Disclosure.Panel className="mt-4 ml-8 rounded-xl bg-white px-6 py-4">
                                                    ...
                                                    {inst.comp.schema.map((section) => (
                                                        <DynamicSection
                                                            ...
                                                            setData={(newData) => {
                                                                setComponentFormsPerLang((prev) => ({
                                                                    ...prev,
                                                                    [activeLang]: prev[activeLang].map((i) =>
                                                                        i.uid === inst.uid ? { ...i, data: newData } : i,
                                                                    ),
                                                                }));
                                                            }}
                                                        />
