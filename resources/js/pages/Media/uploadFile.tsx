...
import { CloudUpload, CircleCheck, CircleX, X, FileText } from 'lucide-react';
                ...
                <div className='flex justify-between'>
                  <div className='flex gap-4 items-center'>
                    ...
                    {file.status === 'pending' && (
                      file.preview ? (
                        ...
                        <div className="w-12 h-12 rounded-md border flex items-center justify-center bg-grey">
                          <FileText className="w-6 h-6 text-grey1" />
                        </div>
                      )
                    )}
                  ...
                  <div className='flex items-center gap-4'>
                    ...
                    <button 
                      ...
                      disabled={file.status === 'uploading'}
                    >
                      <X className="h-5 w-5 text-red cursor-pointer" />
                    </button>
                  </div>
                </div>
              </li>
